...
const StockPriceWidget = ({ symbol }) => {
  ...
  return (
    <div
      ...
      } border-2 rounded-xl p-3 sm:p-3.5 shadow-md relative overflow-hidden`}
    >
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-3 sm:gap-4">
          <div className="flex-1 min-w-0 w-full">
            <div className="flex items-center gap-2 mb-2 flex-wrap">
              <h2 className="text-base sm:text-xl lg:text-2xl font-bold text-gray-900 break-words">
                {stockData.companyName}
              </h2>
              <span className="px-2 py-0.5 bg-gradient-to-r from-green-500 to-green-600 text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg animate-pulse flex-shrink-0">
                LIVE
              </span>
            </div>
            ...
            <div className="flex flex-wrap items-baseline gap-2 sm:gap-3">
              ...
              <div
                className={`flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg shadow-md ${
            ...
            <p className="text-[10px] sm:text-xs text-gray-600 mt-2 font-medium">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-2 w-full lg:w-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-lg p-2 border-2 border-gray-200 min-w-0">
              <p className="text-gray-600 font-semibold text-[10px] sm:text-xs uppercase tracking-wide">
                Open
              </p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-lg p-2 border-2 border-green-200 min-w-0">
              <p className="text-green-700 font-semibold text-[10px] sm:text-xs uppercase tracking-wide">
                Day High
              </p>
              <p className="text-green-800 font-bold text-sm sm:text-base mt-0.5">
                ₹{parseFloat(stockData.dayHigh).toFixed(2)}
              </p>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-lg p-2 border-2 border-red-200 min-w-0">
              <p className="text-red-700 font-semibold text-[10px] sm:text-xs uppercase tracking-wide">
                Day Low
              </p>
              <p className="text-red-800 font-bold text-sm sm:text-base mt-0.5">
